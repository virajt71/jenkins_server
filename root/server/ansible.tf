...
module "terragrunt" {
  ...
  playbook_filename = local.terragrunt
  host_public_ip    = module.network.public_ip_addresses.web
...
module "jenkins_pipeline_terragrunt_scm" {
  ...
  playbook_filename = local.jenkins_pipeline_terragrunt_scm
  host_public_ip    = module.network.public_ip_addresses.web
...
# Trigger  pipeline in jenkins via ansible
module "terragrunt_scm_trigger" {
  source = "../../modules/ansible"

  playbook_filename = local.terragrunt_scm_trigger
  host_public_ip    = module.network.public_ip_addresses.web
  ...
  depends_on = [ module.jenkins_pipeline_terragrunt_scm ]
}
